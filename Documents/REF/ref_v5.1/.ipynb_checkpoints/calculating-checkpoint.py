...
def calculate_matrices_and_reflection(matrix, rough_res, Ndots, lambd):
    """
    ...
    i_indices2 = 12.56637 * np.sin(m.pi*(i_indices+10)/18000)/lambd
    ...
    return reflection_coefficient, i_indices2