...
def convolution(r, qmax, q0, Ndots_norm, sigma01, sigma02, gap):
    """
    ...
    sigma_matrix = np.array([resolution_function_smooth_step(qmax, q, sigma01, sigma02, gap) for q in q0])[:, np.newaxis]
