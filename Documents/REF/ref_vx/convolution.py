...
def convolution(r, sigma, Ndots_norm):
    """
    ...
    q0_a = np.linspace(0, 1, Ndots)  # нормированная шкала от 0 до 1
    ...
    q_matrix = q0_a[:, np.newaxis] * q_window
    indices_matrix = np.searchsorted(q0_a, q_matrix)
